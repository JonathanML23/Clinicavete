<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AgregarCita.aspx.cs" Inherits="Clinicavete.AgregarCita" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-container">
        <label for="ddlMascota">Seleccione la mascota:</label>
        <asp:DropDownList ID="ddlMascota" runat="server"></asp:DropDownList>
    </div>

    <div class="form-container">
        <label for="txtFecha">Seleccione la próxima fecha:</label>
        <asp:TextBox ID="txtFecha" runat="server" TextMode="Date"></asp:TextBox>
    </div>

    <div class="form-container">
        <label for="txtMedico">Nombre del médico asignado:</label>
